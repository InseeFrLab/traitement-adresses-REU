...
COG2022 = pl.read_csv(
    rawdatapath + "commune_2022.csv", infer_schema_length=20000
)
historique_communes = pl.read_csv(
    rawdatapath + "communes1943_2022.csv", infer_schema_length=20000
)
historique_communes.filter(pl.col("NCC") == "TRONCHOY")
df = pl.from_arrow(pq.read_table(datapath_init + "adressesREU_brutes.parquet"))
...
pq.write_table(df_final.to_arrow(), datapath_init + "adressesREU_brutes2.parquet")
