...
df = pd.read_parquet(
    datapath + "2_Nettoyage_manuel_adresses/cleaned_addresses_large.parquet"
)
...
df_correspondance.to_parquet(
    datapath + "2_Nettoyage_manuel_adresses/table_correspondance_id_groups.parquet",
    index=False,
)
df_correspondance.to_csv(
    datapath + "2_Nettoyage_manuel_adresses/table_correspondance_id_groups.csv",
    index=False,
)

# Save the full table with the pivoted addresses and our new columns
df.to_parquet(
    datapath + "2_Nettoyage_manuel_adresses/cleaned_addresses_long.parquet",
    index=False,
)
df.head(1000).to_csv(
    datapath + "2_Nettoyage_manuel_adresses/extract_cleaned_addresses_long.csv",
    index=False,
)
...
df_representants.head(1000).to_csv(
    datapath + "2_Nettoyage_manuel_adresses/extract_deduplicated_cleaned_addresses_long.csv",
    index=False,
)
