...
for i in range(n_batchs):
    ...
    sample.to_csv(
        ...
        f'X:/HAB-Adresses-REU/data/2_Nettoyage_manuel_adresses/slices_{int(100 * proportion_sample)}%_deduplicated_cleaned_addresses_long/extract_addresses_{"{:03d}".format(i)}.csv',
        index=False,
    )
