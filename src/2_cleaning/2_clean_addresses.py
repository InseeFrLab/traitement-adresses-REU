...
df = pd.read_parquet(
    datapath + "1_Inputs_nettoyage_manuel_parquet/adressesREU_brutes2.parquet"
)
...
df.to_parquet(
    datapath + "2_Nettoyage_manuel_adresses/cleaned_addresses_large_detailed.parquet",
    index=False,
)
...
df_suspicious.to_csv(
    datapath + "2_Nettoyage_manuel_adresses/suspicious_addresses_analysis/suspicious_addresses.csv",
    index=False,
)
