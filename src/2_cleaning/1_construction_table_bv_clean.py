...
bureaux_vote_insee = pd.read_parquet(
    datapath + "4_Bureaux_de_vote/bureaux_de_vote_insee.parquet"
)
...
table_bv_finale.to_parquet(
    datapath + "4_Bureaux_de_vote/table_correspondance_bv_complete.parquet",
    index=False,
)
...
table_bv_finale_simplifiee.to_parquet(
    datapath + "4_Bureaux_de_vote/table_correspondance_bv_simplifiee.parquet",
    index=False,
)
