...
df_adresses = pd.read_parquet(
    datapath + "1_Inputs_nettoyage_manuel_parquet/adressesBAN_brutes.parquet"
)
df_lieux_dits = pd.read_parquet(
    datapath + "1_Inputs_nettoyage_manuel_parquet/lieuxditsBAN_brutes.parquet"
)
...
df_BAN.to_csv(
    datapath + "2_Nettoyage_manuel_adresses/suspicious_addresses_analysis/suspicious_addresses_BAN.csv",
    index=False,
)
