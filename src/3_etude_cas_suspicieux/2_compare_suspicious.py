...
df_suspicious_BAN.to_parquet(
    "X:/HAB-Adresses-REU/data/2_Nettoyage_manuel_adresses/suspicious_addresses_analysis/comparison_suspicious_addresses.parquet",
    index=False,
)
df_suspicious_BAN.to_csv(
    "X:/HAB-Adresses-REU/data/2_Nettoyage_manuel_adresses/suspicious_addresses_analysis/comparison_suspicious_addresses.csv",
    index=False,
)
